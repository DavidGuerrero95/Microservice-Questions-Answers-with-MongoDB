package com.appcity.app.preguntasrespuestas.models;
...
public class PreguntasRespuestas {
	...
	public PreguntasRespuestas(String nombre, List<List<Preguntas>> preguntas, List<List<List<String>>> respuestas,
